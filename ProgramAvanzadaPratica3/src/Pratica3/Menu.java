...
public class Menu {
	...
	public static void main(String[] args) {
		//throws FileNotFoundException{
			...
			l1.add(h3);
			HotelRestaur h4 = new HotelRestaur("Shajon","Georgie street", "Rome", 450,3, false,false,true, 70,true, "Tariel", "Traditional food", 15, 3,48);
			l1.add(h4);
			...
			try{
				do{
					...
					System.out.println(sentence.getString("LookMenu"));
				   ...
				   case 6:
					   ...
					   System.out.println(sentence.getString("RestMenu"));				
					   nam = p.nextLine();
					   list.readMenu(nam);
