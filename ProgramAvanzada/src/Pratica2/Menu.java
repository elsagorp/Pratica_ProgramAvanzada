...
public class Menu {
	...
	public static void main(String[] args) {
		...
		languag = sc.nextInt();
		loc.setLoc(languag);
		ResourceBundle sentence = ResourceBundle.getBundle("Pratica2.Messages", loc.getLocale());
		try{
			do{
				...
				case 3:
					...
					switch(caso2) {
						case 1:
							filt = new Lista(list.filter(true,false));
							System.out.println(filt.consultaHotel());
							break;
						case 2:
							filt = new Lista(list.filter(false,true));
							System.out.println(filt.consultaHotel());
							break;
						case 3:
							filt = new Lista(list.filter(true,true));
							System.out.println(filt.consultaHotel());
							break;
						case 4:
							filt = new Lista(list.filter(false,false));
							System.out.println(filt.consultaHotel());
							break;
						case 5:
							filt = new Lista(list.filter(true,false));
							filt2 = new Lista(list.filter(true,true));
							filt3 = new Lista(list.addListas(filt,filt2));
							
							System.out.println(filt3.consultaHotel());
							break;
						case 6:
							filt = new Lista(list.filter(true,true));
							filt2 = new Lista(list.filter(false,true));
							filt3 = new Lista(list.addListas(filt,filt2));
							System.out.println(filt3.consultaHotel());
							break;
				...
				case 4:
					...
					if(cas == 1) System.out.println(cli.getAtributos(sentence));
